...
; (function ($, window, undefined) {
    ...
    */
    ...
    function renderAddNewRow() {
        ...
        var tpl = this.options.templates,
            append = $(tpl.actions.resolve(getParams.call(this))),
            addButtonSelector = getCssSelector(this.options.css.addRowOption),
                    addRowOption = $(tpl.search.resolve(getParams.call(this))),
                    addButton1 = (addRowOption.is(addButtonSelector)) ? addRowOption :
                        addRowOption.find(addButtonSelector);
        if (this.options.nameAddRow != "") {

            var addButton = tpl.addNewRowButton.resolve(getParams.call(this, { text: this.options.nameAddRow }))
            this.header.append(addButton);
            $(tpl.addNewRowButton.resolve(getParams.call(this, { text: this.options.nameAddRow }))).on("click" + namespace, function (e) {
                alert("aa")
            });
    ...
    Grid.defaults = {
         ...
         **/
        css: {
            addRowOption: "btn btn-default bottonAdd",
            add:"add css",
         ...
         **/
        templates: {
            addNewRowButton: "<button type=\"button\" class=\"{{css.addRowOption}}\" data-toggle=\"modal\" data-target=\"#myModal\"><span class=\"glyphicon glyphicon-plus\"></span>{{ctx.text}}</button>",
            actionButton: "<div class=\"btn-group\"><button class=\"btn btn-default form-control\" type=\"button\" title=\"{{ctx.text}}\">{{ctx.content}}</button></div>",
